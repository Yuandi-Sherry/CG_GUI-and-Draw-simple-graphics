...
int main() {
	try {
		...
		homework8.init(vertexShaderFile, fragmentShaderFile);
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos) {
	...
	homework8.mouseCallback(window, xpos, ypos);
...
void mouse_button_callback(GLFWwindow* window, int button, int action, int mods) {
	homework8.mouseButtonCallBack(button, action);
}